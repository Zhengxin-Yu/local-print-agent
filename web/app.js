(() => {
  ...
  function showError(source, message) {
    if (source === "refresh" && errorState.source && errorState.source !== "refresh") return;
    errorState.source = source; errorState.message = message;
    errorBox.textContent = message; errorBox.hidden = false;
  }
  function clearError(source) {
    if (errorState.source !== source) return;
    errorState.source = ""; errorState.message = "";
    errorBox.textContent = ""; errorBox.hidden = true;
  }
